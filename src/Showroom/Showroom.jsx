      ...
      <Row className="pharmacy_index pt-4 pb-4 m-0 p-0">
        <Col md={12}>
          ...
          <p className="showroom">
            <b>Showrooms</b> - (10,000 Drugs Available)
          </p>
          <Row>
            {drugData.map((item) => (
              <Col lg={2}>
                <Card
                  className="showroom_card shadow-sm"
                  onClick={() => {
                    toggle()
                    setSelectItem(item)
                  }}
                >
                  ...
                  <div className="p-2">
                    ...
                    <h5 className="drug_name mt-3">
                      {item.drugPrice} <span className="near">Near/set</span>
                    </h5>
                    <span className="near">10 cartons (min. order)</span>
                    <h5 className="drug_supplier mt-3">
                      {item.drugSupplier.length > 26
                        ? `${item.drugSupplier.substring(0, 26)}...`
                        : item.drugSupplier}
                    </h5>
                    <Button
